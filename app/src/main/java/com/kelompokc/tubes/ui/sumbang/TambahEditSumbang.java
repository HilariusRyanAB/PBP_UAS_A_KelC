...
public class TambahEditSumbang extends Fragment {
    ...
    public void init(){
        ...
        if(status.equals("edit"))
        {
            ...
            txtNoSeri.setText(String.valueOf(Math.round(buku.getNoSeri())));
            Glide.with(view.getContext())
                    .load(BukuAPI.URL_IMAGE +buku.getImgURL())
    ...
    private void setAttribut() {
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(JudulBuku.isEmpty() || Genre.isEmpty() || txtNoSeri.getText().toString().isEmpty())
                    Toast.makeText(getContext(), "Data Tidak Boleh Kosong !", Toast.LENGTH_SHORT).show();
                else{
                    Double harga     = Double.parseDouble(txtNoSeri.getText().toString());
                    buku = new Buku(JudulBuku, Genre, harga);
                    String gambar = "";
                    if (bitmap != null){
                    ...
                    if(status.equals("tambah"))
                        tambahBuku(JudulBuku,Genre,harga,gambar);
                    else
                        editBuku(idBuku,JudulBuku,Genre,harga,gambar);
                }
            }
        });
    ...
    public void closeFragment(){
        ...
        transaction.hide(TambahEditSumbang.this).detach(this)
                .attach(this).commit();
    }
    ...
    public void tambahBuku(final String judulBuku, final String genre, final String noSeri, final String gambar){
        ...
        StringRequest stringRequest = new StringRequest(POST, BukuAPI.URL_ADD, SumbangAPI.URL_ADD, new Response.Listener<String>() {
            @Override
    ...
    public void editBuku(final int id,final String judulBuku, final String genre, final String noSeri, final String gambar) {
        RequestQueue queue = Volley.newRequestQueue(getContext());
        ...
        StringRequest  stringRequest = new StringRequest(PUT, BukuAPI.URL_UPDATE + id, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams()
            {
                ...
                */
                ...
                params.put("genre", genre);
                params.put("noSeri", noSeri.toString());
                params.put("ImgURL", gambar);
