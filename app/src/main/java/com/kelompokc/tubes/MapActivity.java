...
//    private FloatingActionButton searchfab;
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        ...
                        if (response.body() == null) {
                            Toast.makeText(MapActivity.this, "No routes found, make sure you set the right user and access token.", Toast.LENGTH_SHORT).show();
                            return;
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            case R.id.style_streets:
                mapboxMap.setStyle(Style.MAPBOX_STREETS);
                return true;
            case R.id.style_outdoors:
                mapboxMap.setStyle(Style.OUTDOORS);
                return true;
            case R.id.style_light:
                mapboxMap.setStyle(Style.LIGHT);
                return true;
            case R.id.style_dark:
                mapboxMap.setStyle(Style.DARK);
                return true;
            case R.id.style_satellite:
                mapboxMap.setStyle(Style.SATELLITE);
                return true;
            case R.id.style_traffic_day:
                mapboxMap.setStyle(Style.TRAFFIC_DAY);
                return true;
            case R.id.style_traffic_night:
